...
public class EbuyBackAction implements IEbuyBackAction {
	...
	public List<EasybuyProductCategory> getPc() {
		 ...
		 *//*
			 * List<EasybuyProductCategory> list = new ArrayList<>(); list.add(new
			 * EasybuyProductCategory(1, "化妆品")); list.add(new EasybuyProductCategory(2,
			 * "箱包")); list.add(new EasybuyProductCategory(3, "保健食品")); list.add(new
